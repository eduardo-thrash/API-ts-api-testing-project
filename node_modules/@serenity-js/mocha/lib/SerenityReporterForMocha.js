...
class SerenityReporterForMocha extends mocha_1.reporters.Base {
    ...
    announceSceneStartsFor(test) {
        ...
        this.emit(new events_1.SceneStarts(this.currentSceneId, scenario, this.serenity.currentTime()), new events_1.SceneTagged(this.currentSceneId, new model_1.FeatureTag(scenario.category.value), this.serenity.currentTime()), new events_1.TestRunnerDetected(this.currentSceneId, new model_1.Name('Mocha'), this.serenity.currentTime()));
    }
    ...
    announceSceneSkippedFor(test) {
        ...
        this.announceSceneStartsFor(test);
        this.emit(new events_1.SceneFinishes(this.currentSceneId, this.serenity.currentTime()), new events_1.SceneFinished(this.currentSceneId, scenario, outcome, this.serenity.currentTime()));
    }
